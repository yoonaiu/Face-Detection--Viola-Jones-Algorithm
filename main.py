...
clf = adaboost.Adaboost(T=10)  # 10 is the max accuracy, even 20, 50 can't have more accuracy maybe cuz overfitting
clf.train(trainData)
...
detection.detect('data/detect/detectDataMine.txt', clf)
